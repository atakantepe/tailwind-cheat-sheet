...
function Topbar() {
    ...
    return (
        <>
            <div
                className="flex items-center justify-between w-full px-8 py-[1.23rem] backdrop-blur-[2px] text-white rounded-[2rem] border border-white/10 mb-[3.25rem]"
            ...
            >
                ...
                <div className="text-white/80 flex gap-3">
                    ...
                    <div className="border-l border-white/10 pl-3">
                        <button
                            onClick={toggleTheme}
                            className="flex items-center justify-center w-[42px] h-[42px] border border-white/10 rounded-full backdrop-blur-[2px] hover:border-white/40 transition-all duration-200"
                            style={{ background: 'linear-gradient(2deg, #022055 -48.06%, #021337 98.2%)' }}
                        >
                            {isDarkMode ? (
                                <svg xmlns="http://www.w3.org/2000/svg" className="fill-white w-4" viewBox="0 0 512 512">
